...
\begin{document}
	...
	\begin{frame}[t]{What is Cryptography?}
		\begin{itemize}
			\item \textbf{Cryptography} is the science of securing information so that it can only be read or understood by intended parties.
			\item It enables:
			\begin{itemize}
				\item \textbf{Confidentiality} – Keeps information hidden from unauthorized parties using encryption.
				\item \textbf{Integrity} – Ensures data hasn't been altered, using cryptographic hashes or message authentication codes.
				\item \textbf{Authentication} – Confirms the identity of the sender, typically via digital signatures.
				\item \textbf{Non-repudiation} – Prevents denial of sending messages; digital signatures provide proof of origin.
			\end{itemize}
			\item It is used in secure messaging, online banking, blockchains, and privacy-preserving computation.
